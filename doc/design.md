...
* Catalogs are also task managers that manage and report on current AND past read and write jobs
...
* A fork in intended to be used as a short-lived transition from a mirror, cache or clone into a sink, AKA "Save As...".
