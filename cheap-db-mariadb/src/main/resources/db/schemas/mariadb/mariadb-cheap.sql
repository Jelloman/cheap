...
-- AspectDef indexes
CREATE INDEX IF NOT EXISTS idx_aspect_def_name ON aspect_def(name(255));

-- PropertyDef indexes (non-FK)
CREATE INDEX IF NOT EXISTS idx_property_def_name ON property_def(name(255));

-- Catalog indexes (non-FK)
CREATE INDEX IF NOT EXISTS idx_catalog_species ON catalog(species);

-- Hierarchy indexes (non-FK)
CREATE INDEX IF NOT EXISTS idx_hierarchy_name ON hierarchy(name(255));
CREATE INDEX IF NOT EXISTS idx_hierarchy_type ON hierarchy(hierarchy_type);

-- Aspect indexes (non-FK)
CREATE INDEX IF NOT EXISTS idx_aspect_hierarchy_name ON aspect(hierarchy_name(255));

-- Property value indexes (non-FK)
CREATE INDEX IF NOT EXISTS idx_property_value_name ON property_value(property_name(255));
...
CREATE INDEX IF NOT EXISTS idx_hierarchy_entity_list_name ON hierarchy_entity_list(hierarchy_name(255));
...
CREATE INDEX IF NOT EXISTS idx_hierarchy_entity_set_name ON hierarchy_entity_set(hierarchy_name(255));

CREATE INDEX IF NOT EXISTS idx_hierarchy_entity_directory_catalog_id ON hierarchy_entity_directory(catalog_id);
CREATE INDEX IF NOT EXISTS idx_hierarchy_entity_directory_name ON hierarchy_entity_directory(hierarchy_name(255));
CREATE INDEX IF NOT EXISTS idx_hierarchy_entity_directory_key ON hierarchy_entity_directory(entity_key(255));

CREATE INDEX IF NOT EXISTS idx_hierarchy_entity_tree_catalog_id ON hierarchy_entity_tree_node(catalog_id);
CREATE INDEX IF NOT EXISTS idx_hierarchy_entity_tree_name ON hierarchy_entity_tree_node(hierarchy_name(255));
CREATE INDEX IF NOT EXISTS idx_hierarchy_entity_tree_path ON hierarchy_entity_tree_node(node_path(255));

CREATE INDEX IF NOT EXISTS idx_hierarchy_aspect_map_catalog_id ON hierarchy_aspect_map(catalog_id);
CREATE INDEX IF NOT EXISTS idx_hierarchy_aspect_map_name ON hierarchy_aspect_map(hierarchy_name(255));
